...
export const metadata: Metadata = {
  title: "thesolopreneur.app | The CRM Solopreneurs Deserve",
  description:
    "GoHighLevel power without the bloat. Funnels, CRM, templates, and AI agents built for freelancers, founders, and micro agencies.",
  generator: "v0.app",
  icons: {
    icon: [
      {

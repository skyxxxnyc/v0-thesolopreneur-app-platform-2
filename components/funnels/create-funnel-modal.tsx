...
const templates: FunnelTemplate[] = [
  ...
  },
  {
    id: "saas-launch",
    name: "SaaS Launch",
    description: "Product launch with waitlist, VSL, and checkout",
    category: "sales",
    thumbnail: "",
    pages: [
      {
  ...
  },
  {
    id: "lead-magnet",
    name: "Lead Magnet",
    description: "Opt-in, thank you page, and email sequence",
    category: "lead-gen",
    thumbnail: "",
    pages: [
      {
  ...
  },
  {
    id: "product-launch",
    name: "Product Launch",
    description: "Pre-launch buzz, cart open, and scarcity close",
    category: "sales",
    thumbnail: "",
    pages: [
      {
  ...
  },
  {
    ...
    description: "Registration, reminders, and replay pages",
    category: "webinar",
    thumbnail: "",
    pages: [
      {
  ...
  },
  {
    ...
    description: "Trial signup, onboarding, and upgrade prompts",
    category: "sales",
    thumbnail: "",
    pages: [
      {
  ...
  },
  {
    ...
    description: "Application form and calendar integration",
    category: "lead-gen",
    thumbnail: "",
    pages: [
      {
  ...
  },
  {
    id: "course-sales",
    name: "Course Sales",
    description: "VSL, curriculum preview, and payment pages",
    category: "sales",
    thumbnail: "",
    pages: [
      {
  ...
  },
  {
    id: "tripwire",
    name: "Tripwire",
    description: "Low-ticket offer with upsell sequence",
    category: "sales",
    thumbnail: "",
    pages: [
      {
  ...
  },
  {
    id: "application",
    name: "Application",
    description: "High-ticket application and screening system",
    category: "lead-gen",
    thumbnail: "",
    pages: [
      {
  ...
  },
  {
    ...
    description: "Multi-day event with all-access pass upsell",
    category: "webinar",
    thumbnail: "",
    pages: [
      {
  ...
  },
  {
    ...
    description: "Membership tiers and payment plan options",
    category: "sales",
    thumbnail: "",
    pages: [
      {
  ...
  },
  {
    id: "quiz",
    name: "Quiz Funnel",
    description: "Interactive quiz with personalized results",
    category: "lead-gen",
    thumbnail: "",
    pages: [
      {
  ...
  },
  {
    id: "challenge",
    name: "Challenge",
    description: "5-7 day challenge with paid upgrade offer",
    category: "webinar",
    thumbnail: "",
    pages: [
      {
  ...
  },
  {
    ...
    description: "Early bird pricing and workshop materials",
    category: "webinar",
    thumbnail: "",
    pages: [
      {
  ...
  },
  {
    ...
    description: "Product showcase with cart abandonment recovery",
    category: "sales",
    thumbnail: "",
    pages: [
      {
  ...
  },
  {
    id: "book-launch",
    name: "Book Launch",
    description: "Book preview with bonus packages",
    category: "sales",
    thumbnail: "",
    pages: [
      {
  ...
  },
  {
    ...
    description: "Recruit affiliates with training materials",
    category: "lead-gen",
    thumbnail: "",
    pages: [
      {
  ...
  },
  {
    id: "local-service",
    name: "Local Service",
    description: "Quote calculator with service area map",
    category: "lead-gen",
    thumbnail: "",
    pages: [
      {
  ...
  },
  {
    id: "downsell",
    name: "Downsell",
    description: "Cart abandonment recovery with lower price",
    category: "sales",
    thumbnail: "",
    pages: [
      {
  ...
  },
  {
    id: "event-ticket",
    name: "Event Ticket",
    description: "In-person event with VIP ticket tiers",
    category: "webinar",
    thumbnail: "",
    pages: [
      {
...
const categoryIcons: Record<string, React.ReactNode> = {
  blank: <LayoutTemplate className="w-5 h-5" />,
